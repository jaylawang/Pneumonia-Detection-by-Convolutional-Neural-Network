...
## Dataset
The SSBD dataset can be downloaded from Roland Goecke's research page. The dataset contains about 25 videos of hand flapping, head banging, and spinning behaviors.
